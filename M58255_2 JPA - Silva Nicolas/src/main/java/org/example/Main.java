...
public class Main {
    public static void main(String[] args) {
        ...
        // Promociones
        TipoPromocion promocionHappyHour = TipoPromocion.HAPPY_HOUR;
        ...
        Promocion promo1 = Promocion.builder()
                ...
                .precioPromocional(String.valueOf(precioRedondeado))
                .build();
        ...
        Promocion promo2 = Promocion.builder()
                ...
                .precioPromocional(String.valueOf(precioRedondeado2))
                .build();
        ...
        Promocion promo3 = Promocion.builder()
                ...
                .precioPromocional(String.valueOf(precioRedondeado3))
                .build();

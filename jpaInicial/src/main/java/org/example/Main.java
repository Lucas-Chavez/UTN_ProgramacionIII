...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Factura factura1 = Factura.builder().numero(26).fecha("10/11/2024").build();

            Domicilio domicilio1 = Domicilio.builder().nombreCalle("Viamonte").numero(2933).build();
            Cliente cliente1 = Cliente.builder().nombre("Geronimo").apellido("Lopez").dni(42403294).domicilio(domicilio1).build();
            ...
            Categoria cat3 = Categoria.builder().denominacion("Indumentaria").build();

            Articulo art1 = Articulo.builder().denominacion("Leche").precio(200).cantidad(50).build();
            Articulo art2 = Articulo.builder().denominacion("Medias").precio(450).cantidad(10).build();
            ...
            DetalleFactura detalle2 = DetalleFactura.builder().articulo(art2).cantidad(2).subtotal(900).build();
            ...
            System.out.println("Factura recuperada: " + retrievedFactura.getNumero());
